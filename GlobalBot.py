...
async def uptime(message, trigger):
    ...
    await sendMessage(message, f'The current instance of the bot was launched at {launchTime} UTC. Current uptime is {uptime}.', triggeredCommand = trigger, codeBlock = True)
